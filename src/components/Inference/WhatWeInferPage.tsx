...
export function WhatWeInferPage({ onBack }) {
  return (
    <div className="what-we-infer-page">

  <h1 style={{ marginBottom: "24px" }}>What We Infer</h1>

  {/* ============================================================
      COLLAPSIBLE 1: WHEN WRITING ASSESSMENTS
  ============================================================ */}
  ...
  {/* ============================================================
      COLLAPSIBLE 2: WHEN GENERATING STUDENTS
  ============================================================ */}
  <Collapsible defaultOpen={false}>
    <CollapsibleTrigger className="collapsible-trigger">
      <span className="arrow">▶</span>
  ...
  {/* ============================================================
      COLLAPSIBLE 3: WHAT EACH INPUT DOES
  ============================================================ */}
  <Collapsible defaultOpen={false}>
    <CollapsibleTrigger className="collapsible-trigger">
      <span className="arrow">▶</span>
