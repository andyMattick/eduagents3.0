  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const assignmentDetail = {
        ...
        subject: assignment.topic, // Use topic as subject
        gradeLevel: '9-12', // Default, should be captured in intent data
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '2rem', padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', fontSize: '14px', marginBottom: '1.5rem' }}>
          <div>
        ...
        <div style={{ marginTop: '1.5rem', paddingTop: '1.5rem', borderTop: '1px solid #ddd' }}>
          <h4 style={{ marginTop: 0, fontSize: '13px', fontWeight: 'bold', color: '#666', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
            Problems Preview
          </h4>
          <div style={{ maxHeight: '300px', overflowY: 'auto' }}>
            {assignment.sections.map((section, sIdx) => (
              <div key={sIdx} style={{ marginBottom: '1rem' }}>
                <div style={{ fontSize: '12px', fontWeight: 'bold', color: '#333', marginBottom: '0.5rem' }}>
                ...
                {section.problems.length > 3 && (
                  <div style={{ fontSize: '12px', color: '#999', padding: '0.5rem' }}>
