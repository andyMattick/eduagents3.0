  ...
  return (
    <div style={containerStyle}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <h1 style={{ marginTop: 0, color: '#333' }}>🔍 Assignment Analysis & Improvement</h1>

        {isLoading ? (
          <div style={loadingStyle}>
            <p style={{ fontSize: '16px', margin: 0 }}>⏳ Analyzing assignment...</p>
          ...
          <>
            ...
            <div style={{
              ...
              <strong>📋 Summary:</strong> {summaryComment}
            </div>
            ...
            <div style={tabsStyle}>
              ...
              >
                📝 Notes ({analysis.peerReviewComments.length})
              </div>
              <div
                onClick={() => setActiveTab('students')}
                style={tabStyle(activeTab === 'students')}
              >
                👥 Simulations ({studentSimulations.length})
              </div>
              <div
