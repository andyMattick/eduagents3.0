...
const localPrismRoutes: LocalApiRoute[] = [
  ...
  { pattern: /^\/documents\/session-analysis$/, modulePath: '/api/v4/documents/session-analysis.js' },
  {
    ...
    modulePath: '/api/v4/documents/session/[sessionId]/analysis.js',
  ...
  { pattern: /^\/sessions\/blueprint$/, modulePath: '/api/v4/sessions/blueprint.js' },
  {
    ...
    modulePath: '/api/v4/sessions/assessment-preview.js',
    queryFromMatch: (match) => ({ sessionId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/sessions\/([^/]+)\/builder-plan$/,
    modulePath: '/api/v4/sessions/builder-plan.js',
    queryFromMatch: (match) => ({ sessionId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/sessions\/([^/]+)\/blueprint$/,
    modulePath: '/api/v4/sessions/blueprint.js',
    queryFromMatch: (match) => ({ sessionId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/students\/([^/]+)\/performance$/,
    modulePath: '/api/v4/students/[studentId]/performance.js',
    queryFromMatch: (match) => ({ studentId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/teachers\/([^/]+)\/fingerprint$/,
    modulePath: '/api/v4/teachers/[teacherId]/fingerprint.js',
    queryFromMatch: (match) => ({ teacherId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/classes\/([^/]+)\/performance$/,
    modulePath: '/api/v4/classes/[classId]/performance.js',
    queryFromMatch: (match) => ({ classId: decodeURIComponent(match[1] ?? '') }),
  },
  { pattern: /^\/classes$/, modulePath: '/api/v4/classes/index.js' },
  {
    pattern: /^\/classes\/([^/]+)$/,
    modulePath: '/api/v4/classes/[classId].js',
    queryFromMatch: (match) => ({ classId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/classes\/([^/]+)\/regenerate$/,
    modulePath: '/api/v4/classes/[classId]/regenerate.js',
    queryFromMatch: (match) => ({ classId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/classes\/([^/]+)\/differentiated-build$/,
    modulePath: '/api/v4/classes/[classId]/differentiated-build.js',
    queryFromMatch: (match) => ({ classId: decodeURIComponent(match[1] ?? '') }),
  },
  ...
  { pattern: /^\/narrate-problem$/, modulePath: '/api/v4/narrate-problem.js' },
  { pattern: /^\/teacher-feedback\/templates$/, modulePath: '/api/v4/teacher-feedback/templates.js' },
  { pattern: /^\/teacher-feedback\/assessment-blueprint$/, modulePath: '/api/v4/teacher-feedback/assessment-blueprint.js' },
  { pattern: /^\/teacher-feedback\/concept-verification-preview$/, modulePath: '/api/v4/teacher-feedback/concept-verification-preview.js' },
  { pattern: /^\/teacher-feedback\/regenerate-item$/, modulePath: '/api/v4/teacher-feedback/regenerate-item.js' },
  { pattern: /^\/teacher-feedback\/regenerate-section$/, modulePath: '/api/v4/teacher-feedback/regenerate-section.js' },
  { pattern: /^\/teacher-feedback\/learning$/, modulePath: '/api/v4/teacher-feedback/learning.js' },
  {
    pattern: /^\/teacher-feedback\/([^/]+)$/,
    modulePath: '/api/v4/teacher-feedback/[canonicalProblemId].js',
    queryFromMatch: (match) => ({ canonicalProblemId: decodeURIComponent(match[1] ?? '') }),
  },
  { pattern: /^\/teacher-feedback$/, modulePath: '/api/v4/teacher-feedback.js' },
  {
    pattern: /^\/problem-overrides\/([^/]+)$/,
    modulePath: '/api/v4/problem-overrides/[canonicalProblemId].js',
    queryFromMatch: (match) => ({ canonicalProblemId: decodeURIComponent(match[1] ?? '') }),
  },
  { pattern: /^\/student-performance\/ingestAssessment$/, modulePath: '/api/v4/student-performance/ingestAssessment.js' },
  { pattern: /^\/student-portal\/documents\/submit$/, modulePath: '/api/v4/student-portal/documents/submit.js' },
  // ── Studio routes ──────────────────────────────────────────────────────────
  {
    pattern: /^\/studio\/sessions\/([^/]+)$/,
    modulePath: '/api/v4/studio/sessions/[sessionId].js',
    queryFromMatch: (match) => ({ sessionId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/studio\/sessions\/([^/]+)\/analysis$/,
    modulePath: '/api/v4/studio/sessions/[sessionId]/analysis.js',
    queryFromMatch: (match) => ({ sessionId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/studio\/sessions\/([^/]+)\/blueprints$/,
    modulePath: '/api/v4/studio/sessions/[sessionId]/blueprints.js',
    queryFromMatch: (match) => ({ sessionId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/studio\/sessions\/([^/]+)\/active-blueprint$/,
    modulePath: '/api/v4/studio/sessions/[sessionId]/active-blueprint.js',
    queryFromMatch: (match) => ({ sessionId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/studio\/sessions\/([^/]+)\/outputs$/,
    modulePath: '/api/v4/studio/sessions/[sessionId]/outputs.js',
    queryFromMatch: (match) => ({ sessionId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/studio\/blueprints\/([^/]+)\/versions\/([^/]+)$/,
    modulePath: '/api/v4/studio/blueprints/[blueprintId]/versions/[version].js',
    queryFromMatch: (match) => ({ blueprintId: decodeURIComponent(match[1] ?? ''), version: decodeURIComponent(match[2] ?? '') }),
  },
  {
    pattern: /^\/studio\/blueprints\/([^/]+)\/versions$/,
    modulePath: '/api/v4/studio/blueprints/[blueprintId]/versions.js',
    queryFromMatch: (match) => ({ blueprintId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/studio\/blueprints\/([^/]+)\/outputs\/assessment$/,
    modulePath: '/api/v4/studio/blueprints/[blueprintId]/outputs/assessment.js',
    queryFromMatch: (match) => ({ blueprintId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/studio\/blueprints\/([^/]+)$/,
    modulePath: '/api/v4/studio/blueprints/[blueprintId].js',
    queryFromMatch: (match) => ({ blueprintId: decodeURIComponent(match[1] ?? '') }),
  },
  {
    pattern: /^\/studio\/outputs\/([^/]+)\/items\/([^/]+)\/rewrite$/,
    modulePath: '/api/v4/studio/outputs/[outputId]/items/[itemId]/rewrite.js',
  ...
  },
  {
    ...
    modulePath: '/api/v4/studio/outputs/[outputId]/items/[itemId]/replace.js',
    queryFromMatch: (match) => ({ outputId: decodeURIComponent(match[1] ?? ''), itemId: decodeURIComponent(match[2] ?? '') }),
  },
  {
    pattern: /^\/studio\/outputs\/([^/]+)$/,
    modulePath: '/api/v4/studio/outputs/[outputId].js',
    queryFromMatch: (match) => ({ outputId: decodeURIComponent(match[1] ?? '') }),
  },
  { pattern: /^\/studio\/generateItems$/, modulePath: '/api/v4/studio/generateItems.js' },
  { pattern: /^\/simulator\/single$/, modulePath: '/api/v4/simulator/single.js' },
  { pattern: /^\/simulator\/shortcircuit$/, modulePath: '/api/v4/simulator/shortcircuit.js' },
  { pattern: /^\/simulator\/segment$/, modulePath: '/api/v4/simulator/segment.js' },
  { pattern: /^\/simulator\/debug\/segmentation$/, modulePath: '/api/v4/simulator/debug/segmentation.js' },
  { pattern: /^\/preparedness$/, modulePath: '/api/v4/preparedness.js' },
  { pattern: /^\/preparedness-intel$/, modulePath: '/api/v4/preparedness-intel.js' },
  { pattern: /^\/concept-match\/intel$/, modulePath: '/api/v4/concept-match/intel.js' },
  { pattern: /^\/concept-match\/test-evidence$/, modulePath: '/api/v4/concept-match/test-evidence.js' },
  { pattern: /^\/concept-match\/generate$/, modulePath: '/api/v4/concept-match/generate.js' },
  { pattern: /^\/simulator\/multi$/, modulePath: '/api/v4/simulator/multi.js' },
  { pattern: /^\/simulator\/generate-test$/, modulePath: '/api/v4/simulator/generate-test.js' },
  { pattern: /^\/rewrite$/, modulePath: '/api/v4/rewrite/index.js' },
  { pattern: /^\/usage\/today$/, modulePath: '/api/v4/usage/today.js' },
]

const localApiRoutes: LocalApiRoute[] = [
  { pattern: /^\/rewrite$/, modulePath: '/api/rewrite/index.js' },
  { pattern: /^\/rewrite\/report-bad$/, modulePath: '/api/rewrite/report-bad.js' },
]
