...
const localPrismRoutes: LocalApiRoute[] = [
  ...
  { pattern: /^\/simulator\/segment$/, modulePath: '/api/v4/simulator/segment.ts' },
  { pattern: /^\/simulator\/debug\/segmentation$/, modulePath: '/api/v4/simulator/debug/segmentation.ts' },
  ...
  { pattern: /^\/concept-match\/test-evidence$/, modulePath: '/api/v4/concept-match/test-evidence.ts' },
  { pattern: /^\/concept-match\/generate$/, modulePath: '/api/v4/concept-match/generate.ts' },
